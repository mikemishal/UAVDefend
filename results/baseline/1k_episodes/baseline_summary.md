...
- **Mean Episode Length**: 19.0 steps
...
- **Best performing speed**: v_d = 20 (48% success)
- **Correlation with success**: r = 1.00 (positive)
- **Success range**: 20% (v_d=10) → 48% (v_d=20)
...
- **Best case**: v_e = 8 (62% success)
- **Worst case**: v_e = 14 (38% success)
- **Correlation with success**: r = -0.94 (negative)
- **Performance degradation**: 24 percentage points across range
...
- **Correlation with success**: r = 0.99
- **Success range**: 34% → 42%
...
- **Best configuration**: v_d=14, v_e=8 (63% success)
- **Worst configuration**: v_d=12, v_e=18 (10% success)
- **Minimum speed ratio for 50% success**: v_d/v_e ≥ 1.50
- **Success at equal speeds (v_d = v_e)**: 30%
